...
# Research Lead — Realestate Research Orchestrator
...
- **Constraints:** Realestate-specific context (TBD SMB first, realestate.com, GEO platform for AI search visibility)
...
- Example decomposition for "research GEO optimization tools market":
  - Thread 1: "Who are the top 5 competitors to Realestate — features, pricing, positioning (realestate.com is the product)"
...
context_files: [CLAUDE.md for Realestate stack context]
return_format:
