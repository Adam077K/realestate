...
- **DO NOT skip reading `docs/ENGINEERING_PRINCIPLES.md`.** Realestate has specific Zod and error-handling patterns — evaluate against them, not against generic Node.js norms.
