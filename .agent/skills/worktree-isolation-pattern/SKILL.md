...
description: "The exact git worktree create, detect, and clean pattern for Realestate workers: detect-or-create from main-repo-root, child worktree commands, branch naming conventions (feat/fix/chore), atomic commits, and .worktrees/ gitignore enforcement."
tags: [git, realestate-specific, workflow, workers]
...
# /Users/adamks/VibeCoding/Realestate                      abc1234 [main]
# /Users/adamks/VibeCoding/Realestate/.worktrees/ceo-1-xxx  def5678 [ceo-1-xxx]
...
pnpm -F @realestate/web exec tsc --noEmit apps/web/src/app/api/scan/route.ts

# Lint
pnpm -F @realestate/web lint --max-warnings 0
```
...
# Run relevant tests
pnpm -F @realestate/web test -- --testPathPattern="scan"
...
```json
{
  ...
  "worktree": "/Users/adamks/VibeCoding/Realestate/.worktrees/scan-rate-limit",
  "files_changed": [
